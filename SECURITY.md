...
| Version | Supported          |
| ------- | ------------------ |
| 2.x.x   | :white_check_mark: Current Stable, actively developing |
| 1.x.x   | :hammer_and_wrench: Security updates only |
| < 1.0   | :x: Not supported |
...
- Vulnerabilities in the `async-customerio` library code itself
- Issues in how the library handles API keys or credentials
- Misuse of dependencies (`httpx`) within the library

The following are out of scope:

- Vulnerabilities in Customer.io services themselves (report to Customer.io)
